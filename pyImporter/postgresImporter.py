...
set_fks += "ALTER TABLE \"public\".\"ds_omodelgeneratormodule_raxml\" ADD CONSTRAINT \"ds_omodelgeneratormodule_raxml_modelgeneratormodule_raxml_task_id_fkey\" FOREIGN KEY (\"modelgeneratormodule_raxml_task_id\") REFERENCES \"public\".\"task\" (\"id\") ON DELETE CASCADE ON UPDATE CASCADE; ALTER TABLE \"public\".\"ds_oprogramexecutemodule_raxml\" ADD CONSTRAINT \"ds_oprogramexecutemodule_raxml_programexecutemodule_raxml_task_id_fkey\" FOREIGN KEY (\"programexecutemodule_raxml_task_id\") REFERENCES \"public\".\"task\" (\"id\") ON DELETE CASCADE ON UPDATE CASCADE; ALTER TABLE \"public\".\"ds_oremovepipemodule_mrb\" ADD CONSTRAINT \"ds_oremovepipemodule_mrb_removepipemodule_mrb_task_id_fkey\" FOREIGN KEY (\"removepipemodule_mrb_task_id\") REFERENCES \"public\".\"task\" (\"id\") ON DELETE CASCADE ON UPDATE CASCADE;"
